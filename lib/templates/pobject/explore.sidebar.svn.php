		...
		if (count($svn_info)) {
			$tasks = array(
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svninfo.png',
				...
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svndiff.png',
				...
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svncommit.png',
				...
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svnrevert.png',
				...
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svnupdate.png',
				...
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/unsvn.png',
			...
			$tasks = array(
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svncheckout.png',
				...
				array(
					...
					'icon' => $AR->assets->images . 'icons/small/svnimport.png',
